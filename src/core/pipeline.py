    ...
    def run(self, video_name: str, detections: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for track_id, track_dets in tracks_data.items():
            ...
            for det in track_dets:
                ...
                current_votes = voting_system.get_votes(track_id)
        ...
        for track_id in voting_system.votes.keys():
            ...
            final_votes = voting_system.get_votes(track_id)
            track_votes_summary[track_id] = final_votes
            print(f"Resultado Final -> Track {track_id} | Vencedor: {winner} | Placar Final: {final_votes}")
            
        return {
            "model": self.model_name,
            "frames_processed": frames_processed,
            "track_winners": track_winners,
            "track_votes": track_votes_summary,
